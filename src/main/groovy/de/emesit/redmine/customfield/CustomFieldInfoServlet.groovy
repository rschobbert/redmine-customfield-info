...
/**
 * <p>
 * A servlet which can be used to serve information on redmine custom fields.
 ...
 * <pre>
 *     &lt;servlet&gt;
 *      &lt;servlet-name&gt;CustomFieldInfoServlet&lt;/servlet-name&gt;
 *      &lt;servlet-class&gt;de.emesit.redmine.customfield.CustomFieldInfoServlet&lt;/servlet-class&gt;
 *      &lt;init-param&gt;
 ...
 */
class CustomFieldInfoServlet extends HttpServlet {
    private static final Logger LOG = LoggerFactory.getLogger(CustomFieldInfoServlet.class)
    ...
    void init(ServletConfig config) throws ServletException {
        ...
        LOG.info("Initialized CustomFieldInfoServlet with $redmineDatabases.size() redmineDatabases: $redmineDatabases")
    }
